...
class ShoppingCartsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_cart" do
    assert_difference('ShoppingCart.count') do
      post :create, shopping_cart: { menu_id: @shopping_cart.menu_id, quantity: @shopping_cart.quantity, user_id: @shopping_cart.user_id }
    end
  ...
  test "should update shopping_cart" do
    patch :update, id: @shopping_cart, shopping_cart: { menu_id: @shopping_cart.menu_id, quantity: @shopping_cart.quantity, user_id: @shopping_cart.user_id }
    assert_redirected_to shopping_cart_path(assigns(:shopping_cart))
  end
