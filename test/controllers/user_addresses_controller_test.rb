...
class UserAddressesControllerTest < ActionController::TestCase
  ...
  test "should create user_address" do
    assert_difference('UserAddress.count') do
      post :create, user_address: { address: @user_address.address, district_id: @user_address.district_id, is_default: @user_address.is_default, name: @user_address.name, user_id: @user_address.user_id }
    end
  ...
  test "should update user_address" do
    patch :update, id: @user_address, user_address: { address: @user_address.address, district_id: @user_address.district_id, is_default: @user_address.is_default, name: @user_address.name, user_id: @user_address.user_id }
    assert_redirected_to user_address_path(assigns(:user_address))
  end
