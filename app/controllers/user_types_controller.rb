class UserTypesController < ApplicationController
  ...
  # GET /user_types.json
  def index
    @user_types = UserType.all.paginate(:page => params[:page], :per_page => 5)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @user_type.save
        format.html { redirect_to @user_type, notice: 'Customer type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @user_type.update(user_type_params)
        format.html { redirect_to @user_type, notice: 'Customer type was successfully updated.' }
  ...
  def destroy
    @user_type.destroy
    respond_to do |format|
      format.html { redirect_to user_types_url, notice: 'Customer type was successfully destroyed.' }
